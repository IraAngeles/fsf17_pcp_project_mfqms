...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ssdb`.`documents` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ssdb`.`summaries` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ssdb`.`attachments` ;
...
-- Table `ssdb`.`owners`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ssdb`.`owners` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ssdb`.`products_affected` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ssdb`.`transactions` ;
